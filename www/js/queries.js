  ...
  $.ajax(
    {
      ...
      success : function(output)
      {
        ...
        {
          if (document.URL.indexOf('accueil.php?page=demande-numero') == -1 && document.URL.indexOf('accueil.php?page=modifier-profil-pro') == -1) {
  ...
  $.ajax(
    {
      ...
      success : function(output)
      {
        ...
        switch (output) {
          ...
          break;
          case "ko":
          $('#register_response').text("Addresse email incorrecte").append('<br/></br>');
          break;
        default:
  ...
  $.ajax(
    {
      ...
      success : function(output)
      {
        if (output === "NEED_INIT" && window.location.href.indexOf("modifier-profil-pro") === -1)
          ...
          if (output === "NEED_NAME" && window.location.href.indexOf("modifier-profil-pro") === -1 && getSession())
            {
...
//          if (obj.length < 100)
  ...
  $("#photo-content").append('<div class="col-xs-4"><a class="thumbnail float-left fakelink thumb" onclick="changePhoto1();"><img src="http://www.prolinked.fr/'+obj[0]+'" alt="..."></a></b></li></div><form class="hidden" action="upload_user_img_1_pro.php" id="user_img_1_form" method="post" enctype="multipart/form-data"><input type="file" name="user_img_1" id="user_img_1" value=""></form><script type="text/javascript">document.getElementById("user_img_1").onchange = function() {document.getElementById("user_img_1_form").submit();}</script>');
  $("#photo-content").append('<div class="col-xs-4"><a class="thumbnail float-left fakelink thumb" onclick="changePhoto2();"><img src="http://www.prolinked.fr/'+obj[1]+'" alt="..."></a></b></li></div><form class="hidden" action="upload_user_img_2_pro.php" id="user_img_2_form" method="post" enctype="multipart/form-data"><input type="file" name="user_img_2" id="user_img_2" value=""></form><script type="text/javascript">document.getElementById("user_img_2").onchange = function() {document.getElementById("user_img_2_form").submit();}</script>');
  $("#photo-content").append('<div class="col-xs-4"><a class="thumbnail float-left fakelink thumb" onclick="changePhoto3();"><img src="http://www.prolinked.fr/'+obj[2]+'" alt="..."></a></b></li></div><form class="hidden" action="upload_user_img_3_pro.php" id="user_img_3_form" method="post" enctype="multipart/form-data"><input type="file" name="user_img_3" id="user_img_3" value=""></form><script type="text/javascript">document.getElementById("user_img_3").onchange = function() {document.getElementById("user_img_3_form").submit();}</script>');
...
//          if (obj.length < 100)
  ...
  $("#info-content").append('<div class="col-xs-4"><a class="thumbnail float-left fakelink" onclick="changePhoto1();"><img class="thumb" src="http://www.prolinked.fr/'+obj[0]+'" alt="..."></a></b></li></div><form class="hidden" action="upload_user_img_1.php" id="user_img_1_form" method="post" enctype="multipart/form-data"><input type="file" name="user_img_1" id="user_img_1" value=""></form><script type="text/javascript">document.getElementById("user_img_1").onchange = function() {document.getElementById("user_img_1_form").submit();}</script>');
  $("#info-content").append('<div class="col-xs-4"><a class="thumbnail float-left fakelink " onclick="changePhoto2();"><img class="thumb" src="http://www.prolinked.fr/'+obj[1]+'" alt="..."></a></b></li></div><form class="hidden" action="upload_user_img_2.php" id="user_img_2_form" method="post" enctype="multipart/form-data"><input type="file" name="user_img_2" id="user_img_2" value=""></form><script type="text/javascript">document.getElementById("user_img_2").onchange = function() {document.getElementById("user_img_2_form").submit();}</script>');
  $("#info-content").append('<div class="col-xs-4"><a class="thumbnail float-left fakelink " onclick="changePhoto3();"><img class="thumb" src="http://www.prolinked.fr/'+obj[2]+'" alt="..."></a></b></li></div><form class="hidden" action="upload_user_img_3.php" id="user_img_3_form" method="post" enctype="multipart/form-data"><input type="file" name="user_img_3" id="user_img_3" value=""></form><script type="text/javascript">document.getElementById("user_img_3").onchange = function() {document.getElementById("user_img_3_form").submit();}</script>');
...
function sendSMSrec()
{
  ...
  data    : 'phone=' + $('#input_sms_rec').val() + '&from=' + getSession() + '&user_profession=' + $('#prof').val(),
  type: 'POST',
  success : function(output)
  {
    alert(output);
