...
<div class="center-text row cover-photo-content " style="background: no-repeat center/100% url(<?=$userPro['user_pro_profil_cover']?>)">
  <div class="col-md-12">
  </div>
</div>
...
<div class="row profil-content">
  <div class="row col-md-12 ">
    <div class="profil-photo center " style="background: no-repeat center url(<?=$userPro['user_pro_profile_picture']?>)">
...
<div class="col-xs-6 general-infos">
  <h4 class="center-text"><a href="accueil.php?page=modifier-profil-pro" class="waves-effect btn red-border modifier-btn">Modifier le profil</a></h4>
</div>
