...
<html>
  ...
  <body>
   ...
   <p class="text-center">En attendant, vous pouvez déjà <a href="http://www.prolinked.fr/accueil.php?page=devenez-pro">créer votre compte professionnel</a>, ou bien <a href="http://www.prolinked.fr/accueil.php?page=recommandez">recommander  les professionnels dont vous êtes satisfait</a>. </p>
