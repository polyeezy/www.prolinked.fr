<nav class="navbar navbar-inverse no-bg full-width">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand  center-text" href="index.php"><img id="logo-header" src="img/logo1.png" alt="" /></a>
    </div>
...
<?php
 ...
 ?>
      ...
      if (isset($_GET['page']) && $_GET['page'] == "profil")
      {
        ...
        <li><a class="center-text"href="accueil.php?page=devenez-pro" class="black-font"<?php checkActive("devenez-pro"); ?>>Devenez professionnel</a></li>
      ...
      else
{
 ?>
      ...
      <li><a class="center-text"href="index.php?page=connexion" <?php checkActive("connexion"); ?>>Connexion</a></li>
      <li><a class="center-text"href="index.php?page=inscription" <?php checkActive("inscription"); ?>>Inscription</a></li>
      <?php
}
       ?>
      </ul>
