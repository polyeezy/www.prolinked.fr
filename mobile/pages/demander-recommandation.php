...
être recommandé par un membre de la communauté.</h5>
  </div>
</br>
    ...
    <div class="row">
      ...
      FB.api('/me','GET',{"fields":"id,name,friends{cover,picture{url,height=200px},name}"},function(response) {
          ...
          for (var friendIndex=0; friendIndex<data['data'].length; friendIndex++)
        {
          ...
          nameContainer.className = 'col-md-2 center-text';
          nameContainer.innerHTML = data['data'][friendIndex]['name'];

          var linkContainer = document.createElement("div");
          linkContainer.className = 'col-md-6';
                  ...
                  if ($user['user_id'] != $_SESSION['id'])
{
                  switch ($rec) {
                    ...
                    <div class='row'>
                      <div class='col-md-12  full-width center'><img class='img-responsive center-block rec-img ' src='$img'></div>
                      <div class='col-md-12 center center-text '><span class='nameContainer'>$name</span></div>
                      <div class='col-md-12 center'><a class='full-width rec-link' id='$id'> + DEMANDER UNE RECOMMANDATION</a></div>
                    </div>
                  ";
                  break;
                 ...
                 <img class='img-responsive rec-img center-block' src='$img'>
                  </div>

                  <div class='row col-xs-12 center-text center '>
                  <span class='nameContainer center-text'>$name</span>
                  </div>

                  <div class='row col-md-12 center'>

                  <a class='full-width green-font center-text' id='$id'>Demmande Envoyée <i class='glyphicon glyphicon-ok'></i></a>
                  </div>
                  </div>
";
